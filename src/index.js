...
import DireflowComponent from './direflow-components/direflow-component';

DireflowComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('direflow-component is mounted on the DOM', element);
});
